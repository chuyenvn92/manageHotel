	      ...
	      <div class="container">
	        ...
	        <div class="collapse navbar-collapse">
	          <ul class="nav navbar-nav">
	            <li class="<?php echo (currentpage() == 'index.php') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/index.php" >Chung</a></li>
	            <li class="<?php echo (currentpage() == 'mod_room') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_room/index.php">Quản lí phòng</a></li>
	            <li class="<?php echo (currentpage() == 'mod_accomodation') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_accomodation/index.php">Loại phòng</a></li>
				...
				?>
	            <a href="<?php echo WEB_ROOT; ?>admin/mod_reservation/index.php">Đặt phòng<?php  echo  isset($result->Total) ? '<span style="color:red">(' .$result->Total . ')</span>' : '';?> </a>
	              <?php 
	            	}
	            ?>
	            </li>

	             <li class="<?php echo (currentpage() == 'mod_reports') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_reports/index.php">Báo cáo</a></li>
	            <?php if($_SESSION['ADMIN_UROLE']=="Administrator"){ ?>
	             <li class="<?php echo (currentpage() == 'mod_users') ? "active" : false;?>"><a href="<?php echo WEB_ROOT; ?>admin/mod_users/index.php" >Quản lí người dùng</a></li>
	             <?php } ?>
	            <li class="<?php echo (currentpage() == 'logout.php') ? "active" : false;?>"><a class="toggle-modal" href="#logout">Đăng xuất</a></li>
	          </ul>
