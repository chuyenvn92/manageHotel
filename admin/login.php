                        ...
                        <form role="form" method="POST" action="login.php">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Tên tài khoản" name="email" type="text" autofocus>
                                </div>
                                <div class="form-group">
                                ...
                                <button type="submit"  name="btnlogin" class="btn btn-lg btn-success btn-block">Đăng nhập</button>
                            </fieldset>
                        </form>
                    </div>
                </div>
